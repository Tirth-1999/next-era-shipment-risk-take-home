"""Optional interview API. Run: python -m uvicorn personal.demo.api:app --port 8765."""
...
from personal.demo.server import Demo, Sessions, ROOT
...
def new_stream(body: StreamRequest):
    ...
    try:
        folder = ROOT / 'personal/outputs/interview' / uuid4().hex

...
Use this FastAPI command for all demo pages, including **New stream**. Restarting clears in-memory sessions.
...
See [the runbook](../RUNBOOK.md) for CLI replay and recovery commands.

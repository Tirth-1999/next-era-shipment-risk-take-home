...
Run `PYTHONPATH=src .venv/bin/python -m demo.server` and open `http://127.0.0.1:8765`. See [demo/README.md](demo/README.md) for the walkthrough, session behavior and scope. This interview-practice UI is separate from the assessed engine.
